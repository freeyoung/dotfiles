...
BarWidget {
  ...
  // The drawer opens on hover, and also on request from the keyboard through
  // the IpcHandler below. Keeping the two sources separate is what lets a
  // keyboard-opened drawer survive the pointer moving away, and what lets
  // hover keep working while it is open.
  property bool hoverExpanded: false
  property bool ipcExpanded: false
  readonly property bool expanded: hoverExpanded || ipcExpanded
  ...
  IpcHandler {
    ...
    function toggle(): void {
      root.ipcExpanded = !root.ipcExpanded
    }

    function open(): void {
      root.ipcExpanded = true
    }
